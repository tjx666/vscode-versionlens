 ...
 * ------------------------------------------------------------------------------------------ */
import { TestFixtureMap, testPath } from 'test/unit/utils';
import * as PacoteClientApi from 'providers/npm/pacoteClientApi'
...
export default {
  ...
  'fetchPackage': {
    ...
    'uses npmrc registry': async () => {
      const testPackagePath = path.join(testPath, './unit/providers/npm/fixtures/config');
      ...
      pacoteMock.packument = async (npaResult, opts) => {
        ...
        return npmFixtures.readJSON('./pacote.json').packumentGit
      }
    ...
    'returns a git:// package': async () => {
      ...
      // setup initial call
      pacoteMock.packument = (npaResult, opts) => Promise.resolve(npmFixtures.readJSON('./pacote.json').packumentGit);
    ...
    'returns a github#semver package': async () => {
      ...
      // setup initial call
      pacoteMock.packument = (npaResult, opts) => Promise.resolve(npmFixtures.readJSON('./pacote.json').packumentGitSemver);
      await PacoteClientApi.fetchPackage(testPackagePath, testPackageName, testPackageVersion)
        .then((actual) => {
          assert.equal(actual.source, 'git')
    ...
    'returns a github#committish package': async () => {
      ...
      // setup initial call
      pacoteMock.packument = (npaResult, opts) => Promise.resolve(npmFixtures.readJSON('./pacote.json').packumentGitCommittish);
      await PacoteClientApi.fetchPackage(testPackagePath, testPackageName, testPackageVersion)
        .then((actual) => {
          assert.equal(actual.source, 'git')
    ...
    'returns a registry range package': async () => {
      ...
      // setup initial call
      pacoteMock.packument = (npaResult, opts) => Promise.resolve(npmFixtures.readJSON('./pacote.json').packumentRegistryRange);
      await PacoteClientApi.fetchPackage(testPackagePath, testPackageName, testPackageVersion)
        .then((actual) => {
    ...
    'returns a registry version package': async () => {
      ...
      // setup initial call
      pacoteMock.packument = (npaResult, opts) => Promise.resolve(npmFixtures.readJSON('./pacote.json').packumentRegistryVersion);
      await PacoteClientApi.fetchPackage(testPackagePath, testPackageName, testPackageVersion)
        .then((actual) => {
          assert.equal(actual.source, 'registry')
    ...
    'returns a registry alias package': async () => {
      ...
      // setup initial call
      pacoteMock.packument = (npaResult, opts) => Promise.resolve(npmFixtures.readJSON('./pacote.json').packumentRegistryAlias);
      await PacoteClientApi.fetchPackage(testPackagePath, testPackageName, testPackageVersion)
        .then((actual) => {
          assert.equal(actual.source, 'registry')
          assert.equal(actual.type, 'alias')
          assert.equal(actual.given.name, testPackageName)
