...
export const DotNetCodeLensProviderTests = {
  ...
  beforeEach: () => {
    ...
    this.testProvider = new DotNetCodeLensProvider();
  },

  "evaluateCodeLens": {

    "returns not found": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', null, { type: 'nuget', packageNotFound: true }), null);
    ...
    "returns tagged versions": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', '3.3.3', { type: 'nuget', tag: { name: 'alpha', version: '3.3.3-alpha.1', isPrimaryTag: false } }), null);
      const result = this.testProvider.evaluateCodeLens(codeLens, null)
    ...
    "returns fixed versions": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', '3.3.3', { type: 'nuget', tag: { name: 'satisfies', version: '3.3.3', isPrimaryTag: true, isFixedVersion: true } }), null);
      const result = this.testProvider.evaluateCodeLens(codeLens, null)
    ...
    "returns prerelease versions": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', '3.3.3', { type: 'nuget', isFixedVersion: true, tag: { name: 'satisfies', version: '3.3.3', isPrimaryTag: true, isNewerThanLatest: true } }), null);
      const result = this.testProvider.evaluateCodeLens(codeLens, null)
    ...
    "returns latest version matches": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', '3.3.3', { type: 'nuget', tag: { name: 'satisfies', version: '3.3.3', isPrimaryTag: true, isLatestVersion: true } }), null);
      const result = this.testProvider.evaluateCodeLens(codeLens, null)
    ...
    "returns satisfies latest version": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', '3.3.3', { type: 'nuget', tag: { name: 'satisfies', version: '3.3.3', isPrimaryTag: true, satisfiesLatest: true } }), null);
      const result = this.testProvider.evaluateCodeLens(codeLens, null)
    ...
    "returns updatable versions": () => {
      const codeLens = new PackageCodeLens(this.testRange, null, generatePackage('SomePackage', '1.2.3', { type: 'nuget', tag: { name: 'satisfies', version: '3.2.1', isPrimaryTag: true } }), null);
      const result = this.testProvider.evaluateCodeLens(codeLens, null)
